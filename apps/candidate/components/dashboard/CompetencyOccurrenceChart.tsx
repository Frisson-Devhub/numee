...
const DEFAULT_PILLS = [
    { label: "Problem Solving", active: false },
    { label: "Communication", active: true },
    { label: "Technical knowledge", active: false },
];
...
export interface CompetencyOccurrenceChartProps {
    times?: number;
...
/**
 * Competency theme chart (same interaction as MotivationOccurrenceChart):
 * pills select the active series; placeholder data when unset.
 */
export function CompetencyOccurrenceChart({
    times = 3,
    lineData = DEFAULT_LINE_DATA,
    pills = DEFAULT_PILLS,
}: CompetencyOccurrenceChartProps) {
